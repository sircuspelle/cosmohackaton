"""Оценка риска микрометеороидов и техногенного мусора.

Модуль намеренно не выдаёт бинарное «безопасно»: он возвращает наблюдаемые
метрики, интервал неопределённости и объяснимый score для компаратора окон.
Единицы: расстояние в км, скорость в км/с, поток м⁻²·с⁻¹, масса в г.
"""
...
class DebrisCalculator:
    """Сводит сближения и фон метеороидов к метрикам одного окна."""
    ...
    def calculate_metrics(
        ...
        # Score is a transparent prioritisation heuristic, not a collision probability.
